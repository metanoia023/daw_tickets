...
def solicitarTelefono(request): #Si el formulario fue enviado (submit)
    from tickets.Usuario.forms import TelForm
    msg = ''
    if request.method == 'POST': #completamos los campos declarados en TelForm con los datos enviados por POST.
