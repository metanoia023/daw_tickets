...
-- 
-- Servidor: localhost
-- Tiempo de generación: 19-11-2013 a las 13:40:16
...
INSERT INTO `auth_user` VALUES (1, 'mery', '', '', 'metanoia023@gmail.com', 'pbkdf2_sha256$10000$8fAE9TJKKx9Q$Ox6ZgsY8Lv8zX9bI8N5/0Xrcv2ULsFwKQE8H1Pwq0Co=', 1, 1, 1, '2013-11-10 02:38:39', '2013-11-10 02:38:39');
...
INSERT INTO `tickets_categoria` VALUES (0, '', '');
...
INSERT INTO `tickets_espectaculo` VALUES (1, 'Laura Pausini', 1, 1, '2014-02-08 20:00:00', 0, 'El mejor espectaculo del año no te lo podes perder');
...
INSERT INTO `tickets_sector` VALUES (30, 2, 'Platea Central', 200, 0);
...
INSERT INTO `tickets_ticket` VALUES (1, 1, 1, '2013-11-18 16:27:49', 3000.00, 1234, 1);
INSERT INTO `tickets_ticket` VALUES (2, 1, 1, '2013-11-18 16:39:25', 3000.00, 1234, 2);
INSERT INTO `tickets_ticket` VALUES (3, 2, 2, '2013-11-18 16:39:41', 1000.00, 1234, 2);
INSERT INTO `tickets_ticket` VALUES (4, 1, 1, '2013-11-18 16:40:17', 3000.00, 1234, 4);
...
-- 
-- Filtros para la tabla `tickets_espectaculo`
-- 
ALTER TABLE `tickets_espectaculo`
  ADD CONSTRAINT `categoria_id_refs_id_29952fe` FOREIGN KEY (`categoria_id`) REFERENCES `tickets_categoria` (`id`),
  ADD CONSTRAINT `lugar_id_refs_id_5b1164ea` FOREIGN KEY (`lugar_id`) REFERENCES `tickets_lugar` (`id`);

-- 
-- Filtros para la tabla `tickets_pin`
-- 
ALTER TABLE `tickets_pin`
  ADD CONSTRAINT `telefono_id_refs_id_34a9b490` FOREIGN KEY (`telefono_id`) REFERENCES `tickets_usuario` (`id`);

-- 
-- Filtros para la tabla `tickets_precio`
-- 
ALTER TABLE `tickets_precio`
  ADD CONSTRAINT `espectaculo_id_refs_id_62bad950` FOREIGN KEY (`espectaculo_id`) REFERENCES `tickets_espectaculo` (`id`),
  ADD CONSTRAINT `sector_id_refs_id_57c452d1` FOREIGN KEY (`sector_id`) REFERENCES `tickets_sector` (`id`);

-- 
-- Filtros para la tabla `tickets_sector`
-- 
ALTER TABLE `tickets_sector`
  ADD CONSTRAINT `lugar_id_refs_id_25436e51` FOREIGN KEY (`lugar_id`) REFERENCES `tickets_lugar` (`id`);

-- 
-- Filtros para la tabla `tickets_ticket`
-- 
ALTER TABLE `tickets_ticket`
  ADD CONSTRAINT `espectaculo_id_refs_id_64eb178e` FOREIGN KEY (`espectaculo_id`) REFERENCES `tickets_espectaculo` (`id`),
  ADD CONSTRAINT `lugar_id_refs_id_45eb2e17` FOREIGN KEY (`lugar_id`) REFERENCES `tickets_lugar` (`id`),
  ADD CONSTRAINT `usuario_id_refs_id_6969d2a4` FOREIGN KEY (`usuario_id`) REFERENCES `tickets_usuario` (`id`);
